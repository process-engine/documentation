...
Die Konfiguration einer Klasse kann über den IoC-Container registriert
werden (siehe Dependency Injection).
...
Wenn man den IoC-Container beauftragt, eine neue Instanz einer Klasse
zu erzeugen, kann dabei ein Konfigurationsobjekt mitgegeben werden.
