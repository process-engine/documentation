...
1. [TypeScript](processengine/typescript/README.md)
  ...
  1. [APIs](processengine/typescript/api/README.md)
    * [ConsumerAPI](processengine/typescript/api/consumer_api/README.md)
        ...
        * [Starten von Prozessinstanzen](processengine/typescript/api/consumer_api/start-process-instance.md)
        * [Auflisten wartender UserTasks](processengine/typescript/api/consumer_api/list-waiting-usertasks.md)
        * [Abschließen eines UserTasks](processengine/typescript/api/consumer_api/finish-user-task.md)
        * [Ergebnis einer Prozesskorrelation abfragen](processengine/typescript/api/consumer_api/get-correlation-result.md)
        * [Public API](processengine/typescript/api/consumer_api/public_api.md)
            * [IConsumerApiService](processengine/typescript/api/consumer_api/public_api.md#iconsumerapiservice)
            * [ConsumerContext](processengine/typescript/api/consumer_api/public_api.md#consumercontext)
            * [ProcessModelList](processengine/typescript/api/consumer_api/public_api.md#processmodellist)
            * [ProcessModel](processengine/typescript/api/consumer_api/public_api.md#processmodel)
            * [Event](processengine/typescript/api/consumer_api/public_api.md#event)
            * [StartCallbackType](processengine/typescript/api/consumer_api/public_api.md#startcallbacktype)
            * [ProcessStartRequestPayload](processengine/typescript/api/consumer_api/public_api.md#processstartrequestpayload)
            * [ProcessStartResponsePayload](processengine/typescript/api/consumer_api/public_api.md#processstartresponsepayload)
            * [UserTasks](processengine/typescript/api/consumer_api/public_api.md#usertasks)
            * [UserTaskList](processengine/typescript/api/consumer_api/public_api.md#usertasklist)
            * [UserTask](processengine/typescript/api/consumer_api/public_api.md#usertask)
            * [UserTaskConfig](processengine/typescript/api/consumer_api/public_api.md#usertaskconfig)
            * [UserTaskResult](processengine/typescript/api/consumer_api/public_api.md#usertaskresult)
    * [Management API](processengine/typescript/api/management_api/README.md)
