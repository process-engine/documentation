...
1. [TypeScript](processengine/typescript/README.md)
  ...
  1. [ConsumerAPI](processengine/typescript/consumer_api/README.md)
      ...
      * [Hands-On](processengine/typescript/consumer_api/hands_on/README.md)
          * [Beispiel mit integrierter ProcessEngine](processengine/typescript/consumer_api/hands_on/sample-with-internal-process-engine.md)
          * [Beispiel mit externer ProcessEngine](processengine/typescript/consumer_api/hands_on/sample-with-external-process-engine.md)
              * [Server](processengine/typescript/consumer_api/hands_on/sample-with-external-process-engine.md#server)
              * [Client](processengine/typescript/consumer_api/hands_on/sample-with-external-process-engine.md#client)
              * [Client ohne IoC Container](processengine/typescript/consumer_api/hands_on/sample-with-external-process-engine.md#clientohneioccontainer)
